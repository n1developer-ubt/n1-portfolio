...
import { WorkingDescriptions } from "./Descriptions/data"
...
export default function WhereIHaveWorked() {
   ...
   const GetDescription = () => {
      const workingDes = WorkingDescriptions.find(
         (a) => a.id === DescriptionJob
      )

      if (!workingDes) return <></>

      return <ProjectDescription {...workingDes} />
   }
   const [DescriptionJob, setDescriptionJob] = React.useState("LRCarService")
   return (
      <div
         data-aos='fade-up'
       ...
       sm:justify-center items-start sm:items-center'>
        ...
        rounded md:order-1 order-2  '>
            ...
            <motion.div
               ...
               // ref={barRef}
               className={`absolute w-10 h-0.5 md:w-0.5 md:h-12 rounded bg-AAsecondary `}></motion.div>
         </div>
         ...
         <div className='flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 '>
            <div className='flex flex-row md:flex-col'>
               <CompanyButton
                  ...
                  CompanyName='LRCar Service'
                  BarPosition={0}
                  BarAvobePosition={129}
                  DescriptionJob='LRCarService'
                  CompanyNameBackgroundColorGreen={[
                     false,
                     true,
                     false,
               ...
               <CompanyButton
                  ...
                  DescriptionJob='FiverrFreelancer'
                  CompanyNameBackgroundColorGreen={[
                     false,
                     false,
                     false,
            ...
            <div className='block md:hidden h-0.5 rounded bg-gray-500'>
               <motion.div
                  ...
                  className='w-[128px] h-0.5 rounded bg-AAsecondary'></motion.div>
            </div>
         </div>
      </div>
   )
