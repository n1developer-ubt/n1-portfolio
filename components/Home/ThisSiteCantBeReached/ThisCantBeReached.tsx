         ...
         <div className='relative w-full  flex flex-col space-y-4'>
            ...
            <motion.div
               ...
               <motion.div
                  ...
                  className='absolute left-2 top-3 h-1.5 w-[3.5px] bg-gray-600'></motion.div>
               ...
               <motion.div
                  ...
                  className='absolute right-2 top-3 h-1.5 w-[3.5px] bg-gray-600'></motion.div>
               ...
               <motion.div
                  ...
                  className='absolute right-4 top-0 h-[18px] w-1 bg-gray-600'></motion.div>
               <motion.div
                  ...
                  className='absolute right-0 top-[14px] h-1 w-4 bg-gray-600'></motion.div>
               <motion.div
                  initial={{ opacity: "100%" }}
                  animate={{ opacity: "0%" }}
               ...
               <motion.div
                  ...
                  className='absolute left-[9px] bottom-[7px] w-[3px] h-[3px] bg-gray-600'></motion.div>
               <motion.div
                  animate={{
                     y: [0, -5, 0, -5, 0, -5, 0, -5],
                  }}
                  transition={{ y: { delay: 3, duration: 0.5 } }}
                  className='absolute right-[9px] bottom-[7px] w-[3px] h-[3px] bg-gray-600'></motion.div>
            ...
            <motion.div
               ...
               <span className='text-gray-500 text-md'>
                  <span className='font-bold'>usamabintariq.vercel.app</span>
                  unexpectedly{" "}
                  {ShowText ? (
                     <motion.span
