...
const IconsData = [
   { href: "https://github.com/n1developer-ubt", Icon: GithubIcon },
   {
      href: "https://www.linkedin.com/in/usama-bin--tariq/",
      Icon: LinkedinIcon,
   },
   { href: "https://instagram.com/usama_bin_tariq_", Icon: InstagramIcon },
   {
      href: "https://www.youtube.com/n1developers",
      Icon: YoutubeIcon,
   },
]
...
export default function Fotter(props: {
   ...
   return (
      <div className='bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4 scale-[30%]'>
         {/* // ? Reach me at */}
         <div
